...
class ProfFormTest(TestCase):
    ...
    def test_valid_profile_form(self):
        form = ProfileForm(data={'profile_bio': "profile_bio", 'profile_location': "profile_location", 'profile_bio': "profile_bio", 'profile_phone': '1234567890'})
        self.assertTrue(form.is_valid())

    def test_invalid_profile_form(self):
        form = ProfileForm(data={'profile_bio': "profile_bio", 'profile_location': "profile_location", 'profile_bio': "profile_bio"})
        self.assertFalse(form.is_valid())

class UserFormTest(TestCase):

    def test_valid_user_form(self):
        form = UserForm(data={'first_name': 'first_name', 'last_name': 'last_name'})
        self.assertTrue(form.is_valid())
